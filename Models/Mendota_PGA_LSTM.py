...
import sys
import os
module_dir = '/home/cse/Desktop/Projects/PGA_LSTM/Monotonic LSTM Script'
...
#                       use_bias = lstm_bias, dropout = drop_frac, recurrent_dropout = drop_frac, hidden_dropout = drop_frac, name='aux_output')(main_input)
  mlstm_out = LSTM(units=lstm_nodes,
                     return_sequences=True,
                     use_bias=lstm_bias,
                     dropout=drop_frac,
                     recurrent_dropout=drop_frac,
                     name='aux_output')(main_input)
  ...
  activ_dense3 = tensorflow.keras.layers.ELU(alpha=1.0)(dense3)
